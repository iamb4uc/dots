...
static const char *fonts[]          = { "TerminessTTF Nerd Font Mono:size=15:antialias=true:autohint=true" };
static const char dmenufont[]       = "TerminessTTF Nerd Font Mono:size=15:antialias=true:autohint=true";
